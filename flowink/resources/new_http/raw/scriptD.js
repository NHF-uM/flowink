...
function uploadImage()
{
    ...
    if ((epdInd==3)  || (epdInd==39) || (epdInd==43)) // 2.13
    {
    ...
    if (epdInd == 25 || epdInd == 37) // 7 colors
    {
        xhReq.onload=xhReq.onerror=function()
        {
    ...
    if (epdInd == 50) // 13.3 6 colors (split 1200->600+600)
    {
        var leftA=[];
        var rightA=[];

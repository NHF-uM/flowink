...
static uint8_t scrip_js_gz[] = {
#include "scrip.js.gz.inc"
};
...
static struct http_resource_detail_static scrip_js_gz_resource_detail = {
	.common = {
		.type = HTTP_RESOURCE_TYPE_STATIC,
		.bitmask_of_supported_http_methods = BIT(HTTP_GET),
		.content_encoding = "gzip",
	...
	.static_data = scrip_js_gz,
	.static_data_len = sizeof(scrip_js_gz),
};
...
HTTP_RESOURCE_DEFINE(scrip_js_gz_resource, http_service, "/scrip.js",
					 &scrip_js_gz_resource_detail);
HTTP_RESOURCE_DEFINE(data_up_resource, test_http_service, "/dataUP", &data_up_resource_detail);
